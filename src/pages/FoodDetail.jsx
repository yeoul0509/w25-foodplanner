  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 flex justify-center">
      <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-3xl w-full">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">영양 성분 정보</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">조리 방법 (Manual)</h2>
        <div className="mb-8">
